...
pub fn createSVGNumber(_: *SvgSvg, frame: *Frame) !*SVGNumber {
    return frame._factory.create(SVGNumber{ ._element = null, ._attr_name = String.wrap("") });
}

pub fn createSVGLength(_: *SvgSvg, frame: *Frame) !*SVGLength {
    return frame._factory.create(SVGLength{ ._value = 0, ._unit_type = 1, ._element = null, ._attr_name = String.wrap("") });
}

pub fn createSVGAngle(_: *SvgSvg, frame: *Frame) !*SVGAngle {
    return frame._factory.create(SVGAngle{ ._value = 0, ._unit_type = 1, ._element = null, ._attr_name = String.wrap("") });
}

pub fn pauseAnimations(_: *SvgSvg) void {}

pub fn createSVGPoint(_: *SvgSvg, frame: *Frame) !*DOMPoint {
    return DOMPoint.init(null, null, null, null, frame);
}

pub fn createSVGMatrix(_: *SvgSvg, frame: *Frame) !*DOMMatrix {
    return DOMMatrix.create(RO.identity(), true, frame._page);
}

pub fn createSVGRect(_: *SvgSvg, frame: *Frame) !*DOMRect {
