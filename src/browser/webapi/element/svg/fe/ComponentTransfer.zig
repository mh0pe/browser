...
pub fn get_in(self: *ComponentTransfer) []const u8 {
    return getAttr(self.asElement(), "in");
}
pub fn get_x(self: *ComponentTransfer) []const u8 {
    return getAttr(self.asElement(), "x");
}
pub fn get_y(self: *ComponentTransfer) []const u8 {
    return getAttr(self.asElement(), "y");
}
pub fn get_width(self: *ComponentTransfer) []const u8 {
    return getAttr(self.asElement(), "width");
}
pub fn get_height(self: *ComponentTransfer) []const u8 {
    return getAttr(self.asElement(), "height");
}
pub fn get_result(self: *ComponentTransfer) []const u8 {
