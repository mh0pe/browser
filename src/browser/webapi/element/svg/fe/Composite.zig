...
pub fn get_in(self: *Composite) []const u8 {
    return getAttr(self.asElement(), "in");
}
pub fn get_in2(self: *Composite) []const u8 {
    return getAttr(self.asElement(), "in2");
}
pub fn get_operator(self: *Composite) []const u8 {
    return getAttr(self.asElement(), "operator");
}
pub fn get_k1(self: *Composite) []const u8 {
    return getAttr(self.asElement(), "k1");
}
pub fn get_k2(self: *Composite) []const u8 {
    return getAttr(self.asElement(), "k2");
}
pub fn get_k3(self: *Composite) []const u8 {
    return getAttr(self.asElement(), "k3");
}
pub fn get_k4(self: *Composite) []const u8 {
    return getAttr(self.asElement(), "k4");
}
pub fn get_x(self: *Composite) []const u8 {
    return getAttr(self.asElement(), "x");
}
pub fn get_y(self: *Composite) []const u8 {
    return getAttr(self.asElement(), "y");
}
pub fn get_width(self: *Composite) []const u8 {
    return getAttr(self.asElement(), "width");
}
pub fn get_height(self: *Composite) []const u8 {
    return getAttr(self.asElement(), "height");
}
pub fn get_result(self: *Composite) []const u8 {
