...
pub fn get_in(self: *ConvolveMatrix) []const u8 {
    return getAttr(self.asElement(), "in");
}
fn getOrder(self: *ConvolveMatrix) []const u8 {
    return getAttr(self.asElement(), "order");
}
...
pub fn get_targetX(self: *ConvolveMatrix) []const u8 {
    return getAttr(self.asElement(), "targetX");
}
pub fn get_targetY(self: *ConvolveMatrix) []const u8 {
    return getAttr(self.asElement(), "targetY");
}
pub fn get_edgeMode(self: *ConvolveMatrix) []const u8 {
    return getAttr(self.asElement(), "edgeMode");
}
...
pub fn get_divisor(self: *ConvolveMatrix) []const u8 {
    return getAttr(self.asElement(), "divisor");
}
pub fn get_bias(self: *ConvolveMatrix) []const u8 {
    return getAttr(self.asElement(), "bias");
}
pub fn get_x(self: *ConvolveMatrix) []const u8 {
    return getAttr(self.asElement(), "x");
}
pub fn get_y(self: *ConvolveMatrix) []const u8 {
    return getAttr(self.asElement(), "y");
}
pub fn get_width(self: *ConvolveMatrix) []const u8 {
    return getAttr(self.asElement(), "width");
}
pub fn get_height(self: *ConvolveMatrix) []const u8 {
    return getAttr(self.asElement(), "height");
}
pub fn get_result(self: *ConvolveMatrix) []const u8 {
    return getAttr(self.asElement(), "result");
}
