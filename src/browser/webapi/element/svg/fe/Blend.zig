...
pub fn get_in(self: *Blend) []const u8 {
    return getAttr(self.asElement(), "in");
}
pub fn get_in2(self: *Blend) []const u8 {
    return getAttr(self.asElement(), "in2");
}
pub fn get_mode(self: *Blend) []const u8 {
    return getAttr(self.asElement(), "mode");
}
pub fn get_x(self: *Blend) []const u8 {
    return getAttr(self.asElement(), "x");
}
pub fn get_y(self: *Blend) []const u8 {
    return getAttr(self.asElement(), "y");
}
pub fn get_width(self: *Blend) []const u8 {
    return getAttr(self.asElement(), "width");
}
pub fn get_height(self: *Blend) []const u8 {
    return getAttr(self.asElement(), "height");
}
pub fn get_result(self: *Blend) []const u8 {
