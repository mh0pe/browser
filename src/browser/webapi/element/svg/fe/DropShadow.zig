...
pub fn get_in(self: *DropShadow) []const u8 {
    return getAttr(self.asElement(), "in");
}
pub fn get_dx(self: *DropShadow) []const u8 {
    return getAttr(self.asElement(), "dx");
}
pub fn get_dy(self: *DropShadow) []const u8 {
    return getAttr(self.asElement(), "dy");
}
...
pub fn get_x(self: *DropShadow) []const u8 {
    return getAttr(self.asElement(), "x");
}
pub fn get_y(self: *DropShadow) []const u8 {
    return getAttr(self.asElement(), "y");
}
pub fn get_width(self: *DropShadow) []const u8 {
    return getAttr(self.asElement(), "width");
}
pub fn get_height(self: *DropShadow) []const u8 {
    return getAttr(self.asElement(), "height");
}
pub fn get_result(self: *DropShadow) []const u8 {
