...
pub fn get_in(self: *ColorMatrix) []const u8 {
    return getAttr(self.asElement(), "in");
}
pub fn get_type(self: *ColorMatrix) []const u8 {
    return getAttr(self.asElement(), "type");
}
pub fn get_values(self: *ColorMatrix) []const u8 {
    return getAttr(self.asElement(), "values");
}
pub fn get_x(self: *ColorMatrix) []const u8 {
    return getAttr(self.asElement(), "x");
}
pub fn get_y(self: *ColorMatrix) []const u8 {
    return getAttr(self.asElement(), "y");
}
pub fn get_width(self: *ColorMatrix) []const u8 {
    return getAttr(self.asElement(), "width");
}
pub fn get_height(self: *ColorMatrix) []const u8 {
    return getAttr(self.asElement(), "height");
}
pub fn get_result(self: *ColorMatrix) []const u8 {
