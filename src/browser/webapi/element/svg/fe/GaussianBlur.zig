...
pub fn get_in(self: *GaussianBlur) []const u8 {
...
pub fn get_edgeMode(self: *GaussianBlur) []const u8 {
    return getAttr(self.asElement(), "edgeMode");
}
pub fn get_x(self: *GaussianBlur) []const u8 {
    return getAttr(self.asElement(), "x");
}
pub fn get_y(self: *GaussianBlur) []const u8 {
    return getAttr(self.asElement(), "y");
}
pub fn get_width(self: *GaussianBlur) []const u8 {
    return getAttr(self.asElement(), "width");
}
pub fn get_height(self: *GaussianBlur) []const u8 {
    return getAttr(self.asElement(), "height");
}
pub fn get_result(self: *GaussianBlur) []const u8 {
