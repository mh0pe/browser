...
pub fn get_in(self: *DisplacementMap) []const u8 {
    return getAttr(self.asElement(), "in");
}
pub fn get_in2(self: *DisplacementMap) []const u8 {
    return getAttr(self.asElement(), "in2");
}
pub fn get_scale(self: *DisplacementMap) []const u8 {
    return getAttr(self.asElement(), "scale");
}
...
pub fn get_x(self: *DisplacementMap) []const u8 {
    return getAttr(self.asElement(), "x");
}
pub fn get_y(self: *DisplacementMap) []const u8 {
    return getAttr(self.asElement(), "y");
}
pub fn get_width(self: *DisplacementMap) []const u8 {
    return getAttr(self.asElement(), "width");
}
pub fn get_height(self: *DisplacementMap) []const u8 {
    return getAttr(self.asElement(), "height");
}
pub fn get_result(self: *DisplacementMap) []const u8 {
