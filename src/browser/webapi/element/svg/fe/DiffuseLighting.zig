...
pub fn get_in(self: *DiffuseLighting) []const u8 {
    return getAttr(self.asElement(), "in");
}
pub fn get_surfaceScale(self: *DiffuseLighting) []const u8 {
    return getAttr(self.asElement(), "surfaceScale");
}
...
pub fn get_x(self: *DiffuseLighting) []const u8 {
    return getAttr(self.asElement(), "x");
}
pub fn get_y(self: *DiffuseLighting) []const u8 {
    return getAttr(self.asElement(), "y");
}
pub fn get_width(self: *DiffuseLighting) []const u8 {
    return getAttr(self.asElement(), "width");
}
pub fn get_height(self: *DiffuseLighting) []const u8 {
    return getAttr(self.asElement(), "height");
}
pub fn get_result(self: *DiffuseLighting) []const u8 {
