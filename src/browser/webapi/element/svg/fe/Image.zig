...
pub fn get_href(self: *Image) []const u8 {
    return getAttr(self.asElement(), "href");
}
...
pub fn get_x(self: *Image) []const u8 {
    return getAttr(self.asElement(), "x");
}
pub fn get_y(self: *Image) []const u8 {
    return getAttr(self.asElement(), "y");
}
pub fn get_width(self: *Image) []const u8 {
    return getAttr(self.asElement(), "width");
}
pub fn get_height(self: *Image) []const u8 {
    return getAttr(self.asElement(), "height");
}
pub fn get_result(self: *Image) []const u8 {
