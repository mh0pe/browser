...
pub fn get_azimuth(self: *DistantLight) []const u8 {
    return getAttr(self.asElement(), "azimuth");
}
pub fn get_elevation(self: *DistantLight) []const u8 {
    return getAttr(self.asElement(), "elevation");
}
