...
pub fn getBaseVal(_: *const SVGAnimatedPreserveAspectRatio, frame: *Frame) !*SVGPreserveAspectRatio {
    return frame._factory.create(SVGPreserveAspectRatio{
        ._align = 6, // SVG_PRESERVEASPECTRATIO_XMIDYMID
        ._meet_or_slice = 1, // SVG_MEETORSLICE_MEET
    });
}

pub fn getAnimVal(self: *const SVGAnimatedPreserveAspectRatio, frame: *Frame) !*SVGPreserveAspectRatio {
