...
pub fn setValue(self: *SVGAngle, value: f64, frame: *Frame) !void {
    self._value = value;
...
pub fn newValueSpecifiedUnits(self: *SVGAngle, unit_type: u16, value: f64, frame: *Frame) !void {
...
fn writeBack(self: *SVGAngle, frame: *Frame) !void {
    if (self._element) |elem| {
