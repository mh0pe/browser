...
pub const PageJsApis = flattenTypes(&.{
    ...
    @import("../webapi/element/svg/fe/Blend.zig"),
    @import("../webapi/element/svg/fe/ColorMatrix.zig"),
    @import("../webapi/element/svg/fe/ComponentTransfer.zig"),
    @import("../webapi/element/svg/fe/Composite.zig"),
    @import("../webapi/element/svg/fe/ConvolveMatrix.zig"),
    @import("../webapi/element/svg/fe/DiffuseLighting.zig"),
    @import("../webapi/element/svg/fe/DisplacementMap.zig"),
    @import("../webapi/element/svg/fe/DistantLight.zig"),
    @import("../webapi/element/svg/fe/DropShadow.zig"),
    @import("../webapi/element/svg/fe/Flood.zig"),
    @import("../webapi/element/svg/fe/FuncR.zig"),
    @import("../webapi/element/svg/fe/FuncG.zig"),
    @import("../webapi/element/svg/fe/FuncB.zig"),
    @import("../webapi/element/svg/fe/FuncA.zig"),
    @import("../webapi/element/svg/fe/GaussianBlur.zig"),
    @import("../webapi/element/svg/fe/Image.zig"),
    @import("../webapi/element/svg/fe/Merge.zig"),
    @import("../webapi/element/svg/fe/MergeNode.zig"),
    @import("../webapi/element/svg/fe/Morphology.zig"),
    @import("../webapi/element/svg/fe/Offset.zig"),
    @import("../webapi/element/svg/fe/PointLight.zig"),
    @import("../webapi/element/svg/fe/SpecularLighting.zig"),
