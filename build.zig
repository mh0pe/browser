...
pub fn build(b: *Build) !void {
...

    {
        ...
        // Strip debug symbols to avoid LLVM lowerDebugType infinite recursion on
        // deep SVG prototype chains (cycle: Svg.Type union → *GeometryElement → *GraphicsElement → *Svg).
